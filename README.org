...
** Add Data to the Bots
     ...
     - Add the file name, Telegram ~file_id~ and downloadable link (usually Dropbox), to the json at the root of each bot folder. To get the ~file_id_~ you can take advantage of [[https://t.me/jsoonbot][@jsonbot]] by just sending the file and copy the id from the reply.
