...
**** General(Maybe) Development
    - [ ] TextReply needs to allow side effects with Message => F[List[String]]. This enable to access resources depending on message text
    - [ ] Twitch support
    - [ ] Discord support
    - [ ] Slack support
...
**** Richard Philip Henry John Benson Bot
    ...
    - [ ] Add a command for a Benson's show by keyword in the title
