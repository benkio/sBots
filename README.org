...
*** GitHub Deploy Workflow (current target)
  ...
  - remote deploy directory: ~/home/benkio/sBots~
  ...
  - The hostname itself does not have to be secret. It can stay hardcoded in the workflow (as now) or be moved to a repository variable for easier changes.
