...
object RichardPHJBensonBot extends TelegramBot
  ...
  val messageRepliesAudio : List[(List[String], MessageHandler, MessageMatches)] = List(
    ...
    (List("cobelini", "cobbolidi", "elfi",
      "eoni", "nani", "mandragola",
      "fico sacro", "betulla", "canfora",
      "ossa dei morti", "erbe", "radici",
      "messico"                               ), "figuremitologiche.mp3",    ContainsOnce),
  ...
  val messageRepliesGifs = List(
    ...
    (List("non ci credete", "stronzata",
      "stronzate"                               ), "noncicredete.gif",       ContainsOnce),
    ...
    (List("non me ne fotte", "chissenefrega",
      "non mi importa", "non mi interessa"      ), "nonmenefotte.gif",       ContainsOnce),
    (List("feste"                               ), "feste.gif",              ContainsOnce),
    (List("ostina", "foto vecchie",
      "ostini"                                  ), "ostina.gif",             ContainsOnce),
    (List("sapere", "sapevo", "sapesse",
      "saperlo", "non lo so", "aristotele"      ), "sodinonsapere.gif",      ContainsOnce),
