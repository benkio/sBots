...
object RichardPHJBensonBot extends TelegramBot
  ...
  val messageRepliesAudio : List[(List[String], MessageHandler, MessageMatches)] = List(
    ...
    (List("assolo di chitarra"                   ), "assolo.mp3",               ContainsOnce),
    (List("ci sei ritornata" , "ci sei ritornato" ), "ritornata.mp3",            ContainsOnce),
    (List("anche la merda"                       ), "merda.mp3",                ContainsOnce),
    ...
    (List("mi fai proprio schifo"                ), "schifo.mp3",               ContainsAll),
  ...
  val messageRepliesGifs = List(
    ...
    (List("facciamo un delirio"                 ), "delirio.gif",            ContainsOnce),
    (List("al paradosso"                        ), "paradosso.gif",          ContainsOnce),
    ...
    (List("mettiti in fila"                     ), "mettitiinfila.gif",      ContainsOnce),
    ...
    (List("mi pare logico", "calcolo",
      "matematica"                              ), "miparelogico.gif",       ContainsOnce),
    ...
    (List("non me ne fotte", "chissenefrega"    ), "nonmenefotte.gif",       ContainsOnce),
    (List("fate le feste"                       ), "feste.gif",              ContainsOnce),
    (List("si ostina", "foto vecchie"           ), "ostina.gif",             ContainsOnce),
    (List("so di non sapere", "aristotele"      ), "sodinonsapere.gif",      ContainsOnce),
    ...
    (List("fate come vi pare", "sti cazzi"      ), "comevipare.gif",         ContainsOnce),
  ...
  val messageRepliesSpecial = List(
    ...
    (List("è una vergogna"                                                 ), "vergogna.gif", "vergogna.mp3",                       ContainsOnce),
    (List("mi devo trasformare", "cristo canaro"                           ), "trasformista.gif", "trasformista.mp3",               ContainsAll),
    (List("masgus", "ma sgus", "ma scusa"                                  ), "masgus.gif", "masgus.mp3",                           ContainsOnce),
    (List("grazie", "gianni"                                               ), "grazie.gif", "grazie.mp3",                           ContainsAll),
    ...
    (List("sai fare le labbra", "sai fare le labbro"                       ), "labbra.gif", "labbra.mp3",                           ContainsOnce),
    (List("la vita è il nemico"                                            ), "vitanemico.gif", "vitanemico.mp3",                   ContainsOnce),
    (List("non te lo puoi permettere"                                      ), "permettere.gif", "permettere.mp3",                   ContainsOnce),
