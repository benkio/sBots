...
object RichardPHJBensonBot extends TelegramBot
  ...
  val messageRepliesAudio : List[(List[String], MessageHandler, MessageMatches)] = List(
    ...
    (List("assolo di chitarra", "ghidarra"       ), "assolo.mp3",               ContainsOnce),
  ...
  val messageRepliesGifs = List(
    ...
    (List("vattene affanculo"                   ), "mavatteneaffanculo.gif", ContainsOnce),
    (List("rimpinzati", "cioccolata", "pandori" ), "rimpinzati.gif",         ContainsOnce),
    ...
    (List("non sapere", "aristotele"      ), "sodinonsapere.gif",      ContainsOnce),
  ...
  val messageRepliesSpecial = List(
    ...
    (List("grazie", "gianni", "ciaoo"                                      ), "grazie.gif", "grazie.mp3",                           ContainsAll),
