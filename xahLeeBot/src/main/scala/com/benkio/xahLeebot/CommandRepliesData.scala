  ...
  def values[F[_]: Async](
    ...
    ReplyBundleCommand[F](
      ...
      mediafiles = List(
        ...
        MediaFile("xah_CExtremeIdioticFak.mp3"),
        MediaFile("xah_WhyIHateCCppIdiocyFaks.mp3"),
        MediaFile("xah_HackerHateCUnixFak.mp3"),
        MediaFile("xah_FakAll.mp3"),
        MediaFile("xah_FakIdioticCUnix.mp3"),
    ...
    ReplyBundleCommand[F](
      ...
      mediafiles = List(
        ...
        MediaFile("xah_FakingAss.mp3"),
        MediaFile("xah_FakIdioticSite.mp3"),
        ...
        MediaFile("xah_MillennialGenZoomersFak.mp3"),
